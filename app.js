...
.park-info {
    font-weight: 300; /* Lighter font for % of rides available */
    margin-bottom: 10px;
}
...
.find-rides-container {
    ...
    display: flex;
    justify-content: center;
    position: relative; /* Ensure reset button aligns correctly */
}
...
@media (max-width: 768px) {
    ...
    .container {
        ...
        max-width: 90%; /* Slightly narrower container on mobile */
    }
